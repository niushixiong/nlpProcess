...
This program is  to create train, test and dev dataset for stanfordSentimentTreebank dataset. It also create phrase train dataset. The label value are 0, 1, 2, 3, 4 for fine train dataset, the meaning of these value are shown as below: 
