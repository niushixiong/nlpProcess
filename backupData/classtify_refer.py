# -*- coding: utf-8 -*-
"""
Created on Wed Mar 09 14:10:29 2016
...
from process.nbsvm_refer import generate_svmlight_files
...
def getCleanReviews(reviews):
    ...
    for review in reviews["review"]:
        clean_reviews.append(Word2VecUtility.review_to_wordlist(review, True))
...
if __name__ == '__main__':
    ...
    for review in train['review']:
        clean_train_reviews.append(" ".join(Word2VecUtility.review_to_wordlist(review)))

    clean_test_reviews = []
    for review in test['review']:
        clean_test_reviews.append(" ".join(Word2VecUtility.review_to_wordlist(review)))
